	...
	<div class="container">
		<div class="section">
			<div class="section-header">
				<h3>Modify User <?php echo $this->Authake->getLogin(); ?></h3>
				...
				<div class="form-horizontal">
					<fieldset class="inputs">
						...
						<div class="string control-group stringish" id="Password">
							<?php echo $this->Form->input('password', array('label'=>array('text'=>__('Password (visible!)'),'class'=>'control-label'),'value'=>'','size'=>'12' ,'between'=>'<div class="controls">', 'after'=>'</div>'));?>
						</div>
