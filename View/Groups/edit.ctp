			...
			<div class="section-header">
				...
				<div class="section-header">
					...
					<div class="section-actions">
						<?php echo $this->Html->link(__d('authake','View group'), array('action'=>'view', $this->Form->value('Group.id')), array('class'=>'btn btn-primary'));?>
						<a href="<?php echo $this->Html->url( array('controller'=> 'rules', 'action'=>'index')); ?>" class="btn btn-link">Cancel</a>
						<?php echo $this->Html->link(__d('authake','Delete'), array('action'=>'delete', $this->Form->value('Group.id')), array('class'=>'btn btn-danger'), sprintf(__d('authake','Are you sure you want to delete @%s?'), $this->Form->value('Group.name'))); ?>
					</div>
				</div>
			</div>
			<div class="section-body">
				...
				<div class="form-horizontal">
					...
					<fieldset class="form-actions">
						...
						<?php echo $this->Html->link(__d('authake','View Rule'), array('action'=>'view', $this->Form->value('Group.id')), array('class'=>'btn btn-primary'));?>
