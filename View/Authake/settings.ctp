		...
		<div class="section">
			<div class="section-header">
				...
				<div class="section-actions">
					...
					<?php echo $this->Html->link(__d('authake','Reset Authake'), array('controller'=>'authake','action'=>'reset'), array('class'=>'btn btn-danger'),'Are you sure you want to reset Authake settings?'); ?>
				</div>
			</div>
				...
				<div class="form-horizontal">
					<fieldset class="inputs">
						<div class="string control-group stringish" id="baseUrl">
							<?php echo $this->Form->input('baseUrl', array('value'=>$configs['baseUrl'],'type'=>'text','label'=>array('text'=>__d('authake','Base URL'),'class'=>'control-label'),'between'=>'<div class="controls">', 'after'=>'<span class="help-inline">Base URL, used to insert the application URL in mails.</span></div>'));?>
						</div>
						<div class="string control-group stringish" id="service">
							<?php echo $this->Form->input('service', array('value'=>$configs['service'],'type'=>'text','label'=>array('text'=>__d('authake','Service'),'class'=>'control-label'),'between'=>'<div class="controls">', 'after'=>'<span class="help-inline">Name of the service i.e. "Super Authake"</span></div>'));?>
						</div>
						<div class="string control-group stringish" id="loginAction">
							<?php echo $this->Form->input('loginAction', array('value'=>$configs['loginAction'],'type'=>'text','label'=>array('text'=>__d('authake','Login Action'),'class'=>'control-label'),'between'=>'<div class="controls">', 'after'=>'<span class="help-inline">Default login action</span></div>'));?>
						</div>
						<div class="string control-group stringish" id="loggedAction">
							<?php echo $this->Form->input('loggedAction', array('value'=>$configs['loggedAction'],'type'=>'text','label'=>array('text'=>__d('authake','Logged Action'),'class'=>'control-label'),'between'=>'<div class="controls">', 'after'=>'<span class="help-inline">Used to redirect the users if the current user is logged out. Basically, this is used in case when The login page is the home page. If this is not set to different location, then it\'s going into recursion.</span></div>'));?>
						</div>
						<div class="string control-group stringish" id="sessionTimeout">
							<?php echo $this->Form->input('sessionTimeout', array('value'=>$configs['sessionTimeout'],'type'=>'number','label'=>array('text'=>__d('authake','Session Timeout'),'class'=>'control-label'),'between'=>'<div class="controls">', 'after'=>'<span class="help-inline">Session timeout in seconds, if managed by Authake (or null to disable)</span></div>'));?>
						</div>
						<div class="string control-group stringish" id="defaultDeniedAction">
							<?php echo $this->Form->input('defaultDeniedAction', array('value'=>$configs['defaultDeniedAction'],'type'=>'text','label'=>array('text'=>__d('authake','Default Denied Action'),'class'=>'control-label'),'between'=>'<div class="controls">', 'after'=>'<span class="help-inline">Default page when access is denied (should be allowed by ACLs...)</span></div>'));?>
						</div>
						<div class="string control-group stringish" id="rulesCacheTimeout">
							<?php echo $this->Form->input('rulesCacheTimeout', array('value'=>$configs['rulesCacheTimeout'],'type'=>'number','label'=>array('text'=>__d('authake','Rules Cache Timeout'),'class'=>'control-label'),'between'=>'<div class="controls">', 'after'=>'<span class="help-inline">Reload all rules every x seconds</span></div>'));?>
						</div>
						<div class="string control-group stringish" id="systemEmail">
							<?php echo $this->Form->input('systemEmail', array('value'=>$configs['systemEmail'],'type'=>'text','label'=>array('text'=>__d('authake','System Email'),'class'=>'control-label'),'between'=>'<div class="controls">', 'after'=>'<span class="help-inline">Email which sends the system mails</span></div>'));?>
						</div>
						<div class="string control-group stringish" id="systemReplyTo">
							<?php echo $this->Form->input('systemReplyTo', array('value'=>$configs['systemReplyTo'],'type'=>'text','label'=>array('text'=>__d('authake','System Reply To'),'class'=>'control-label'),'between'=>'<div class="controls">', 'after'=>'<span class="help-inline">Email which sends the system mails (Reply To)</span></div>'));?>
						</div>
						...
						<div class="string control-group stringish" id="defaultGroup">
							<?php echo $this->Form->input('defaultGroup', array('value'=>$configs['defaultGroup'],'type'=>'number','label'=>array('text'=>__d('authake','Default Group'),'class'=>'control-label'),'between'=>'<div class="controls">', 'after'=>'<span class="help-inline">Default group for registered users If set registered user will be inserted into specified group</span></div>'));?>
						</div>
